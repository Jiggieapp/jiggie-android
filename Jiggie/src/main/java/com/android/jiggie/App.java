...
import com.android.jiggie.component.database.DatabaseConnection;
...
public class App extends Application {
    ...
    public void trackMixPanelEvent(String eventName, SimpleJSONObject json) {
        ...
        json.putString("App Release", BuildConfig.VERSION_NAME);
        json.putString("App Version", String.valueOf(BuildConfig.VERSION_CODE));
