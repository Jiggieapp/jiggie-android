 ...
 */
public class PostMixpanelModel {
    ...
    public String getName_and_fb_id() {
        return name_and_fb_id;
    }

    public void setName_and_fb_id(String name_and_fb_id) {
        this.name_and_fb_id = name_and_fb_id;
    }
